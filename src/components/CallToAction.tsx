    ...
    <section id="contact" className="py-32 md:py-29 bg-foreground text-primary-foreground">
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-primary-foreground/60 text-sm tracking-[0.3em] uppercase mb-8">Бронирование</p>

          <h2 className="text-3xl md:text-4xl lg:text-6xl font-medium leading-[1.1] tracking-tight mb-8 text-balance">
            Забронируйте
            <br />
            апартаменты <HighlightedText>AURA</HighlightedText>
          </h2>

          <p className="text-primary-foreground/70 text-lg md:text-xl leading-relaxed mb-6 max-w-2xl mx-auto">
            Напишите нам — подберём свободный вариант на ваши даты и пришлём реквизиты для оплаты через СБП.
          </p>

          <div className="inline-flex items-center gap-2 bg-primary-foreground/10 border border-primary-foreground/20 px-5 py-2.5 rounded-full text-sm text-primary-foreground/80 mb-10">
